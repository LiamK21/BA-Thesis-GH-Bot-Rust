...
class Config:
    ...
    def setup_pr_related_dirs(self, pr_id: str) -> None:
        """
        ...
        self._setup_pr_log_dir(pr_id)
        self._setup_log_paths()

    def _setup_pr_log_dir(self, pr_id: str) -> None:
        """
    ...
    def setup_output_dir(self, i_attempt: int, model: LLM) -> None:
        ...
        assert self.pr_log_dir is not None, "PR log directory must be set before setting up output directory."
