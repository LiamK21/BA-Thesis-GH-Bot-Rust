...
class GitHubService:
    ...
    def get_linked_data(self) -> str | None:
        ...
        # The regex patterns look for phrases like "Closes #123", "Fixes #123", "Resolves #123",
        # or standalone mentions of "bug 123" or "issue 123" in the PR title and description.
        ...
        issue_matches: list[str] = re.findall(issue_pattern, issue_description, re.IGNORECASE)
        url_matches: list[str] = re.findall(url_pattern, issue_description, re.IGNORECASE)
    ...
    def fetch_file_version(self, commit: str, file_name: str) -> str | bytes:
        """
    ...
    def _get_github_issue(self, number: int) -> str | None:
        ...
        if response.status_code == 200:
            ...
            if any(label.get("name", "").lower() == "bug" for label in issue_labels):
                issue_is_bug = True
